 ...
 * @author @JimmyCSH
 *
 * The following script showBookDetails is used to display
 * the details of a book from our database. This script acts
 * as a search function for Book details our SPEED App.
 */
